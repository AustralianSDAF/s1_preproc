...
wget -q -O /src/snap/esa-snap_sentinel_unix_9_0_0.sh \
  "https://download.esa.int/step/snap/9.0/installers/esa-snap_sentinel_unix_9_0_0.sh"

sh /src/snap/esa-snap_sentinel_unix_9_0_0.sh  -q  -varfile /src/snap/response.varfile
...
# cleanup installer
rm -f /src/snap/esa-snap_sentinel_unix_9_0_0.sh
